...
class EsonVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by EsonParser#mathExpression.
    def visitMathExpression(self, ctx:EsonParser.MathExpressionContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by EsonParser#mathOperation.
    def visitMathOperation(self, ctx:EsonParser.MathOperationContext):
        return self.visitChildren(ctx)
